...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendAppointmentFinishedNotification(Appointment appointment) {
        ...
        context.setVariable("url", "https://smartgymtwo.herokuapp.com/appointments/reject?token=" + jwtTokenService.generateAppointmentRejectionToken(appointment));
    ...
    public void sendAppointmentRejectionRequestedNotification(Appointment appointment) {
        Context context = new Context();
        context.setVariable("appointment", appointment);
        context.setVariable("url", "https://smartgymtwo.herokuapp.com/appointments/acceptRejection?token=" + jwtTokenService.generateAcceptRejectionToken(appointment));
    ...
    public void sendNewChatMessageNotification(ChatMessage chatMessage) {
        ...
        context.setVariable("url", "https://smartgymtwo.herokuapp.com/appointments/" + chatMessage.getAppointment().getId());
    ...
    public void sendNewExchangeRequestedNotification(Appointment oldAppointment, Appointment newAppointment) {
        ...
        context.setVariable("url", "https://smartgymtwo.herokuapp.com/appointments/" + newAppointment.getId());
    ...
    public void sendExchangeRequestAcceptedNotification(ExchangeRequest exchangeRequest) {
        ...
        context.setVariable("url", "https://smartgymtwo.herokuapp.com/appointments/" + exchangeRequest.getRequested().getId());
    ...
    public void sendExchangeRequestRejectedNotification(ExchangeRequest exchangeRequest) {
        Context context = new Context();
        context.setVariable("exchangeRequest", exchangeRequest);
        context.setVariable("url", "https://smartgymtwo.herokuapp.com/appointments/" + exchangeRequest.getRequestor().getId());
